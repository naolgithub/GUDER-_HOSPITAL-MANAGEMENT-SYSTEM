	...
	<div class="overlay overlay-simplegenie">
			...
			<nav>
				<ul>
					...
					<li><a href="patientlogin.php">BOOK AN APPOINTMENT</a></li>
		...
		<section class="header-w3ls"> 
			...
			<a class="page-scroll" href="doctorlogin.php" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Doctor Login</a>
			</div>
		<h1><a href="main.html">GUDER HOSPITAL</a></h1>
...
<div class="banner-bottom">
	<div class="bnr-btm-grids-agileits">
		...
		<div class="bnr-btm-info">
			<h3>Place a call through today</h3>
			<p>+251920617694 </p>
		</div>
		<div class="clearfix"> </div>
	</div>
	<div class="bnr-btm-grids-agileits">
		...
		<div class="bnr-btm-info">
			<h3>Chat with us today</h3>
			<p><a href="info@example.com">example@mail.com</a></p>
		</div>
		<div class="clearfix"> </div>
	</div>
	<div class="bnr-btm-grids-agileits">
		...
		<div class="bnr-btm-info">
			...
			<p>Ethiopia,Oromia,Guder,Guder000.</p>
		</div>
		<div class="clearfix"> </div>
	</div>
	<div class="clearfix"></div>
...
<!-- footer -->
	<div class="footer">
		<div class="agileinfo_footer_bottom1">
			<div class="container">
					<p>© 2020 GUDER HOSPITAL. All rights reserved | Design by <a href="#">OUR TEAMS</a></p>
				<div class="clearfix"> </div>
			</div>
		</div>
	</div>
